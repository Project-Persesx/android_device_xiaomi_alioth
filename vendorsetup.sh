...
git clone https://github.com/Project-Persesx/device_xiaomi_sm8250-common.git  -b clover device/xiaomi/sm8250-common
...
git clone --depth=1 https://github.com/Project-Persesx/kernel_xiaomi_sm8250.git -b bpf2 kernel/xiaomi/sm8250
